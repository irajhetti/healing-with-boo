            ...
            <div className="bg-surface-container-low rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="font-body text-on-surface-variant text-sm leading-relaxed mb-4">
                  Deep to fix, relaxing to soothe or a bit of both. Tailored bodywork from 15-minute scalp rituals to 90-minute full body sessions.
                </p>
          ...
          <Link href="/services/shamanic-healing" className="group block">
            <div className="bg-surface-container-low rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="font-body text-on-surface-variant text-sm leading-relaxed mb-4">
                  Energy healing with spirit, sound healing, and herbs. From kids healing to deep shamanic release with drums, rattles, and breathwork.
                </p>
                <span className="inline-flex items-center text-primary font-bold text-sm group-hover:gap-2 transition-all">
                  From &pound;25
                  <span className="material-symbols-outlined text-[18px] ml-1">arrow_forward</span>
          ...
          <Link href="/services/shamanic-healing" className="group block">
            <div className="bg-surface-container-low rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="font-body text-on-surface-variant text-sm leading-relaxed mb-4">
                  Massage meets healing. From the Total Chill Out to the 3 Hour Intentional Pause &mdash; comprehensive sessions for full body and soul restoration.
                </p>
                <span className="inline-flex items-center text-primary font-bold text-sm group-hover:gap-2 transition-all">
                  From &pound;70
                  <span className="material-symbols-outlined text-[18px] ml-1">arrow_forward</span>
          ...
          <table className="w-full text-left border-separate border-spacing-0">
            ...
            <tbody className="font-body text-sm text-on-surface-variant">
              <tr>
                ...
                <td className="py-5 px-6 border-b border-outline-variant/20">15&ndash;90 minutes</td>
              ...
              <tr>
                ...
                <td className="py-5 px-6 border-b border-outline-variant/20">&pound;12 &ndash; &pound;67</td>
                <td className="py-5 px-6 border-b border-outline-variant/20">&pound;25 &ndash; &pound;90</td>
              ...
              <tr>
                ...
                <td className="py-5 px-6 border-b border-outline-variant/20">
                  Deep tissue, relaxation, scalp rituals, pelvic health massage
                </td>
                <td className="py-5 px-6 border-b border-outline-variant/20">
                  Kids healing, Rebalance, Sacred Womb Activation, Deep Release with drums &amp; breathwork
                </td>
                <td className="py-5 px-6 border-b border-outline-variant/20">
                  Massage &amp; Healing, Full Package, 3 Hour Intentional Pause, Total Chill Out
                </td>
              </tr>
              <tr>
                ...
                <td className="py-5 px-6">
                  Emotional release, energy blockages, feminine healing, children
                </td>
                <td className="py-5 px-6">
      ...
      <section className="bg-surface-container-low py-16 md:py-20">
        <div className="px-6 md:px-12 max-w-3xl mx-auto text-center">
          ...
          <p className="font-body text-on-surface-variant text-base leading-relaxed mb-8">
            That&apos;s completely okay. If you&apos;re not sure what you need, just book a 30 Minute Massage (&pound;27) as a starting point, or message Leah directly on +447425018335 and she&apos;ll help you figure it out. No pressure &mdash; just a warm conversation.
          </p>
          <a
